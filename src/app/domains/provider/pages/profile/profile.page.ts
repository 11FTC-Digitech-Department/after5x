...
export class ProfilePage implements OnInit {
  ...
  private async confirmDeleteAccount() {
    const alert = await this.alertController.create({
      ...
      message: 'Deleting your account will anonymize your profile, remove your login, and sign you out. Your past jobs, payouts, and payment records stay available for reporting with your identity hidden. You can create a new account in the future. Go offline and resolve active jobs, processing payouts, and open support tickets first.',
      buttons: [
        {
          text: 'Cancel',
          role: 'cancel'
