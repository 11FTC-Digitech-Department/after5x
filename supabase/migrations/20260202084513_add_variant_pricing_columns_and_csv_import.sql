...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM public.services WHERE name = 'Re-keying of dimple key') THEN
    ...
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Standard', 1950.00, 1950.00, 3315.00, 3315.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM public.services WHERE name = 'Key Extraction') THEN
    ...
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Standard', 800.00, 1500.00, 1360.00, 2550.00, 49.00, 129.00, 500.00, 15.00, 0.12, 49.00);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM public.services WHERE name = 'Smart key') THEN
    ...
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Standard', 7500.00, 7500.00, 12750.00, 12750.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM public.services WHERE name = 'Vault servicing and maintenance') THEN
    ...
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Standard', 5000.00, 15000.00, 8500.00, 25500.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM public.services WHERE name = 'Digital Safe Combination reset / Code retrieval') THEN
    ...
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Standard', 3000.00, 6000.00, 5100.00, 10200.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
  END IF;
END $$;
...
BEGIN
  ...
  IF v_service_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Chandelier') THEN
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Chandelier', 250.00, 250.00, 425.00, 425.00, 49.00, 129.00, 500.00, 15.00, 0.12, 49.00);
  END IF;
END $$;
...
BEGIN
  ...
  IF v_service_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Customized Key') THEN
    INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
    VALUES (v_service_id, 'Customized Key', 1200.00, 1500.00, 2040.00, 2550.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
  END IF;
END $$;
...
BEGIN
  ...
  IF v_service_id IS NOT NULL THEN
    IF NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Ceiling Fan') THEN
      INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
      VALUES (v_service_id, 'Ceiling Fan', 300.00, 300.00, 510.00, 510.00, 49.00, 129.00, 500.00, 15.00, 0.12, 49.00);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Convenience Outlet') THEN
      INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
      VALUES (v_service_id, 'Convenience Outlet', 200.00, 200.00, 340.00, 340.00, 49.00, 129.00, 500.00, 15.00, 0.12, 49.00);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Electrical Plug') THEN
      INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
      VALUES (v_service_id, 'Electrical Plug', 100.00, 100.00, 170.00, 170.00, 49.00, 129.00, 500.00, 15.00, 0.12, 49.00);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Circuit(Branch)') THEN
      INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
      VALUES (v_service_id, 'Circuit(Branch)', 500.00, 500.00, 850.00, 850.00, 49.00, 129.00, 500.00, 15.00, 0.12, 49.00);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Main Circuit Breaker') THEN
      INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
      VALUES (v_service_id, 'Main Circuit Breaker', 1000.00, 1000.00, 1700.00, 1700.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM public.service_variants WHERE service_id = v_service_id AND name = 'Circuit Breaker Panel Box') THEN
      INSERT INTO public.service_variants (service_id, name, price_min, price_max, price_after5_min, price_after5_max, transportation_fee, transportation_fee_after5, urgent_charge, commission_rate, vat_rate, body_camera_fee)
      VALUES (v_service_id, 'Circuit Breaker Panel Box', 3000.00, 3000.00, 5100.00, 5100.00, 49.00, 129.00, 500.00, 15.00, 0.12, 99.00);
    END IF;
  END IF;
END $$;
...
CREATE TEMP TABLE csv_matrix_data (
  ...
  urgent_charge DECIMAL(10,2)
);

INSERT INTO csv_matrix_data (category_type, service_name, variant_name, price_min, price_max, price_after5_min, price_after5_max, cleaning_type, configuration, fuel_cost, commission_amount_min_8to5, commission_amount_min_5to8, commission_amount_max_8to5, commission_amount_max_5to8, body_camera_fee, urgent_charge) VALUES
('Locksmithing', 'Home lockout assistance', 'Standard', 800.00, 1500.00, 1360.00, 2550.00, 'Deep', '0.5hp, 0.75hp, 1hp, 1.25hp, 1.5hp, 2hp, 2.5hp, 3hp', 100.00, 120.00, 204.00, 225.00, 382.50, 49.00, 500.00),
('Locksmithing', 'Lock installation', 'Standard', 750.00, 1200.00, 1275.00, 2040.00, NULL, NULL, 500.00, 112.50, 191.25, 180.00, 306.00, 49.00, 350.00),
('Locksmithing', 'Smart lock installation', 'Standard', 2500.00, 2500.00, 4250.00, 4250.00, NULL, NULL, 1000.00, 375.00, 637.50, NULL, NULL, 99.00, 500.00),
('Locksmithing', 'Lock repair / Re-keying', 'Standard', 950.00, 1500.00, 1615.00, 2550.00, NULL, NULL, NULL, 142.50, 242.25, 225.00, 382.50, 49.00, 500.00),
('Locksmithing', 'Lock repair / Re-keying', 'Dimple Key', 1950.00, 1950.00, 3315.00, 3315.00, NULL, NULL, NULL, 142.50, 242.25, 225.00, 382.50, 49.00, 500.00),
('Locksmithing', 'Re-keying of dimple key', 'Standard', 1950.00, 1950.00, 3315.00, 3315.00, NULL, NULL, NULL, 292.50, 497.25, NULL, NULL, 99.00, 500.00),
('Locksmithing', 'Smart lock setup and programming', 'Standard', 1500.00, 3000.00, 2550.00, 5100.00, NULL, NULL, NULL, 225.00, 382.50, 450.00, 765.00, 99.00, 500.00),
('Locksmithing', 'Glass door unlocking', 'Standard', 1250.00, 1250.00, 2125.00, 2125.00, NULL, NULL, NULL, 187.50, 318.75, NULL, NULL, 99.00, 500.00),
('Locksmithing', 'Car door lockout', 'Standard', 1250.00, 1950.00, 2125.00, 3315.00, NULL, NULL, NULL, 187.50, 318.75, 292.50, 497.25, 99.00, 500.00),
('Locksmithing', 'Car door lockout', 'Luxury', 2500.00, 3000.00, 4250.00, 5100.00, NULL, NULL, NULL, 375.00, 637.50, 450.00, 765.00, 99.00, 500.00),
('Locksmithing', 'Car key duplication', 'Standard', 700.00, 1200.00, 1190.00, 2040.00, NULL, NULL, 350.00, 105.00, 178.50, 180.00, 306.00, 99.00, 500.00),
('Locksmithing', 'Car key duplication', 'Keyfob', 2500.00, 4500.00, 4250.00, 7650.00, NULL, NULL, NULL, 375.00, 637.50, 675.00, 1147.50, 99.00, 500.00),
('Locksmithing', 'Key extraction', 'Standard', 800.00, 1500.00, 1360.00, 2550.00, NULL, NULL, NULL, 120.00, 204.00, 225.00, 382.50, 49.00, 500.00),
('Locksmithing', 'Smart key', 'Standard', 7500.00, 7500.00, 12750.00, 12750.00, NULL, NULL, NULL, 1125.00, 1912.50, NULL, NULL, 99.00, 500.00),
('Locksmithing', 'Safe/Vault Opening', 'Mechanical', 2500.00, 5000.00, 4250.00, 8500.00, NULL, NULL, NULL, 375.00, 637.50, 750.00, 1275.00, 99.00, 500.00),
('Locksmithing', 'Safe/Vault Opening', 'Digital', 3000.00, 6000.00, 5100.00, 10200.00, NULL, NULL, NULL, 450.00, 765.00, 900.00, 1530.00, 99.00, 500.00),
('Locksmithing', 'Vault servicing and maintenance', 'Standard', 5000.00, 15000.00, 8500.00, 25500.00, NULL, NULL, NULL, 750.00, 1275.00, 2250.00, 3825.00, 99.00, 500.00),
('Locksmithing', 'Digital Safe Combination reset / Code retrieval', 'Standard', 3000.00, 6000.00, 5100.00, 10200.00, NULL, NULL, NULL, 450.00, 765.00, 900.00, 1530.00, 99.00, 500.00),
('Locksmithing', 'Key Duplication', 'Standard', 150.00, 150.00, 225.00, 225.00, NULL, NULL, 75.00, 22.50, 33.75, NULL, NULL, 49.00, 500.00),
('Locksmithing', 'Key Duplication', 'High Security', 500.00, 500.00, 850.00, 850.00, NULL, NULL, 250.00, 75.00, 127.50, NULL, NULL, 49.00, 500.00),
('Locksmithing', 'Key Duplication', 'Dimple Key', 850.00, 850.00, 1445.00, 1445.00, NULL, NULL, 450.00, 127.50, 216.75, NULL, NULL, 49.00, 500.00),
('Locksmithing', 'Key Duplication', 'Laser Cut', 950.00, 950.00, 1615.00, 1615.00, NULL, NULL, 500.00, 142.50, 242.25, NULL, NULL, 49.00, 500.00),
('Locksmithing', 'Key Duplication', 'Customized Key', 1200.00, 1500.00, 2040.00, 2550.00, NULL, NULL, 500.00, 180.00, 306.00, 225.00, 382.50, 99.00, 500.00),
('AC', 'Regular Cleaning', 'Split Type - 1HP', 1200.00, 1200.00, 2040.00, 2040.00, NULL, NULL, 500.00, 180.00, 306.00, NULL, NULL, 99.00, 500.00),
('AC', 'Regular Cleaning', 'Split Type - 1.5HP', 1200.00, 1200.00, 2040.00, 2040.00, NULL, NULL, 500.00, 180.00, 306.00, NULL, NULL, 99.00, 500.00),
('AC', 'Regular Cleaning', 'Split Type - 2HP', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('AC', 'Regular Cleaning', 'Split Type - 3HP', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('AC', 'Regular Cleaning', 'Window (Inverter) - Any', 700.00, 700.00, 1190.00, 1190.00, NULL, NULL, 350.00, 105.00, 178.50, NULL, NULL, 49.00, 500.00),
('AC', 'Regular Cleaning', 'Window (Non-Inv) - 1HP', 500.00, 500.00, 850.00, 850.00, NULL, NULL, 250.00, 75.00, 127.50, NULL, NULL, 49.00, 500.00),
('AC', 'Regular Cleaning', 'Window (Non-Inv) - 1.5HP', 500.00, 500.00, 850.00, 850.00, NULL, NULL, 250.00, 75.00, 127.50, NULL, NULL, 49.00, 500.00),
('AC', 'Regular Cleaning', 'Window (Non-Inv) - 2HP+', 600.00, 600.00, 1020.00, 1020.00, NULL, NULL, 500.00, 90.00, 153.00, NULL, NULL, 49.00, 500.00),
('AC', 'Regular Cleaning', 'Floor Mounted', 3000.00, 3000.00, 5100.00, 5100.00, NULL, NULL, 500.00, 450.00, 765.00, NULL, NULL, 99.00, 500.00),
('AC', 'Regular Cleaning', 'Cassette Type', 5500.00, 5500.00, 9350.00, 9350.00, NULL, NULL, 500.00, 825.00, 1402.50, NULL, NULL, 99.00, 500.00),
('AC', 'AC Repair', 'Ocular / Diagnostic', 500.00, 500.00, 850.00, 850.00, NULL, NULL, 250.00, 75.00, 127.50, NULL, NULL, 49.00, 500.00),
('AC', 'Parts Replacement', 'Window Type - Capacitor', 3500.00, 3500.00, 5950.00, 5950.00, NULL, NULL, 500.00, 525.00, 892.50, NULL, NULL, 99.00, 500.00),
('AC', 'Parts Replacement', 'Window Type - Fan Motor', 3000.00, 3000.00, 5100.00, 5100.00, NULL, NULL, 500.00, 450.00, 765.00, NULL, NULL, 99.00, 500.00),
('AC', 'Parts Replacement', 'Split Type - Capacitor', 3500.00, 3500.00, 5950.00, 5950.00, NULL, NULL, 500.00, 525.00, 892.50, NULL, NULL, 99.00, 500.00),
('AC', 'Parts Replacement', 'Split Type - Fan Motor', 3000.00, 3000.00, 5100.00, 5100.00, NULL, NULL, 500.00, 450.00, 765.00, NULL, NULL, 99.00, 500.00),
('Roadside Assistance', 'Battery Jumpstart', 'Standard', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Roadside Assistance', 'Change of Flat Tire', 'Standard', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Roadside Assistance', 'Fuel Delivery', 'Service Fee (Fuel Cost Extra)', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Roadside Assistance', 'Towing', 'Standard', 3500.00, 3500.00, 5950.00, 5950.00, NULL, NULL, 500.00, 525.00, 892.50, NULL, NULL, 99.00, 500.00),
('Roadside Assistance', 'Towing', 'Luxury / Flatbed', 7000.00, 7000.00, 11900.00, 11900.00, NULL, NULL, 500.00, 1050.00, 1785.00, NULL, NULL, 99.00, 500.00),
('Roadside Assistance', 'Towing', 'Parking Retrieval', 3500.00, 3500.00, 5950.00, 5950.00, NULL, NULL, 500.00, 525.00, 892.50, NULL, NULL, 99.00, 500.00),
('Electrical', 'Relamping', 'Per Bulb', 100.00, 100.00, 170.00, 170.00, NULL, NULL, 50.00, 15.00, 25.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Relamping', 'Standard Fixture', 250.00, 250.00, 425.00, 425.00, NULL, NULL, 500.00, 37.50, 63.75, NULL, NULL, 49.00, 500.00),
('Electrical', 'Relamping', 'Chandelier', 250.00, 250.00, 425.00, 425.00, NULL, NULL, 125.00, 37.50, 63.75, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Standard Install', 250.00, 250.00, 425.00, 425.00, NULL, NULL, 500.00, 37.50, 63.75, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Complex Install', 300.00, 300.00, 510.00, 510.00, NULL, NULL, 500.00, 45.00, 76.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Repair / Fix', 200.00, 200.00, 340.00, 340.00, NULL, NULL, 500.00, 30.00, 51.00, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Circuit Panel', 100.00, 100.00, 170.00, 170.00, NULL, NULL, 500.00, 15.00, 25.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Circuit Breaker Main', 500.00, 500.00, 850.00, 850.00, NULL, NULL, 500.00, 75.00, 127.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Panel Box Install', 1000.00, 1000.00, 1700.00, 1700.00, NULL, NULL, 500.00, 150.00, 255.00, NULL, NULL, 99.00, 500.00),
('Electrical', 'Installation & Replacement', 'Water Heater (Portable)', 1000.00, 1000.00, 1700.00, 1700.00, NULL, NULL, 500.00, 150.00, 255.00, NULL, NULL, 99.00, 500.00),
('Electrical', 'Installation & Replacement', 'Water Heater (Centralized)', 2000.00, 2000.00, 3400.00, 3400.00, NULL, NULL, 500.00, 300.00, 510.00, NULL, NULL, 99.00, 500.00),
('Electrical', 'Installation & Replacement', 'Ceiling Fan', 300.00, 300.00, 510.00, 510.00, NULL, NULL, 150.00, 45.00, 76.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Convenience Outlet', 200.00, 200.00, 340.00, 340.00, NULL, NULL, 100.00, 30.00, 51.00, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Electrical Plug', 100.00, 100.00, 170.00, 170.00, NULL, NULL, 50.00, 15.00, 25.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Circuit(Branch)', 500.00, 500.00, 850.00, 850.00, NULL, NULL, 250.00, 75.00, 127.50, NULL, NULL, 49.00, 500.00),
('Electrical', 'Installation & Replacement', 'Main Circuit Breaker', 1000.00, 1000.00, 1700.00, 1700.00, NULL, NULL, 500.00, 150.00, 255.00, NULL, NULL, 99.00, 500.00),
('Electrical', 'Installation & Replacement', 'Circuit Breaker Panel Box', 3000.00, 3000.00, 5100.00, 5100.00, NULL, NULL, 500.00, 450.00, 765.00, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Declogging & Siphoning', 'Declogging', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Declogging & Siphoning', 'Drain Line Cleaning', 2000.00, 2000.00, 3400.00, 3400.00, NULL, NULL, 500.00, 300.00, 510.00, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Declogging & Siphoning', 'Septic Tank Siphoning', 3500.00, 3500.00, 5950.00, 5950.00, NULL, NULL, 500.00, 525.00, 892.50, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Declogging & Siphoning', 'Sludge Removal', 7000.00, 7000.00, 11900.00, 11900.00, NULL, NULL, 500.00, 1050.00, 1785.00, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Leak / Smoke Test', 'Leak Test', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Leak / Smoke Test', 'Smoke Test', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Plumbing Repair', 'Sink Repair', 300.00, 300.00, 510.00, 510.00, NULL, NULL, 150.00, 45.00, 76.50, NULL, NULL, 49.00, 500.00),
('Plumbing', 'Plumbing Repair', 'Faucet Repair', 150.00, 150.00, 255.00, 255.00, NULL, NULL, 75.00, 22.50, 38.25, NULL, NULL, 49.00, 500.00),
('Plumbing', 'Plumbing Repair', 'Water Heater Install', 1500.00, 1500.00, 2550.00, 2550.00, NULL, NULL, 500.00, 225.00, 382.50, NULL, NULL, 99.00, 500.00),
('Plumbing', 'Plumbing Repair', 'Pipe Leak Repair', 800.00, 5000.00, 1360.00, 8500.00, NULL, NULL, 500.00, 120.00, 204.00, 750.00, 1275.00, 99.00, 500.00);
...
SET
  ...
  urgent_charge = COALESCE(csv.urgent_charge, 500.00),
  ...
  body_camera_fee = COALESCE(csv.body_camera_fee, 0.00),
  updated_at = NOW()
