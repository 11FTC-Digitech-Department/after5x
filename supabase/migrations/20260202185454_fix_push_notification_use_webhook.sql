-- Fix Push Notification: Use webhook approach instead of storing secrets
-- This migration replaces the config table approach with a queue + webhook

-- Drop the config table from previous migration (not needed anymore)
